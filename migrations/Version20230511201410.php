 ...
 */
final class Version20230511201410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, session_formation_id INT NOT NULL, date_inscription DATE NOT NULL, validee TINYINT(1) NOT NULL, INDEX IDX_5E90F6D619EB6921 (client_id), INDEX IDX_5E90F6D69C9D95AF (session_formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
